    ...
    <div className="min-h-screen bg-white flex flex-col">
      <div className="flex-1 px-5 pt-10 pb-8">
        ...
        <div className="flex flex-col items-center mb-6">
          <div
            className="w-[68px] h-[68px] rounded-full border-2 border-dashed border-teal-300 bg-teal-50 flex items-center justify-center text-[22px] font-extrabold text-teal-700 select-none"
            style={{ fontFamily: "'Syne', sans-serif" }}
          >
            {displayName ? displayName.slice(0, 2).toUpperCase() : "?"}
          </div>
          <button type="button" className="mt-2 text-[11px] font-semibold text-teal-600">
            Add photo (optional)
          </button>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                maxLength={20}
                required
                className={`w-full rounded-[11px] border bg-slate-50 pl-7 pr-10 py-3 text-[13px] text-slate-900 outline-none transition-colors focus:bg-white
